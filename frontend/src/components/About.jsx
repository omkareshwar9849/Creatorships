      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Unlock New Growth Opportunities</h2>
                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Boutique Matching</h3>
                  ...
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Equity-based Deals</h3>
                      <p className="text-muted-foreground">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-white">
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="inline-block rounded-lg bg-muted px-3 py-1 text-sm">Monetization Model</div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Aligning Incentives for Growth</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                <ul className="grid gap-6">
                  ...
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Equity-based Model</h3>
                      <p className="text-muted-foreground">
